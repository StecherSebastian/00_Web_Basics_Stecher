...
async function playerX() {
    ...
    if (x == undefined || y == undefined || isNaN(x) || isNaN(y) || x > 2 || y > 2 || x < 0 || y < 0 || field_2D[x][y] == 1 || field_2D[x][y] == 2) {
        console.log(" ");
        console.error("# Invalid Input try again #");
        console.log(" ");
        playerX();

    } else if (field_2D[x][y] == 0) {
